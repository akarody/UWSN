    ...
    public static void main(String args[]){
        ...
        for(j=0;j<nodes;j++){
            ...
            for(i=0;i<nodes;i++){
                ...
                if(i!=j){
                    if( (dist_from_neighbour<=range) && (node[i].dist_from_sink<node[j].dist_from_sink) ) {
                        void_node[j] = 0;
        ...
        //printing values
        System.out.println("-----------------NODE POSTITIONS------------------\n");
        ...
        System.out.println("---------------VOID NODE POSTITIONS---------------\n");
        ...
        System.out.println("---------------TRAP NODE POSTITIONS---------------\n");
